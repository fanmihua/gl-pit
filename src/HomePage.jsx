    ...
    <main className={`pit-home-page is-scene-${scene}`} onWheel={handleWheel}>
      ...
      <section className="pit-journey-scene pit-falling-scene" aria-label="坠入坑底的转场" aria-hidden={scene !== "falling"}>
        <div className="falling-stage" style={mobileFallStyle}>
          ...
          {mobileFallingOrbits && <PitOrbitCurves className="falling-mobile-orbits" mobileOrbits={{ ...mobileFallingOrbits, paths: mobileFallingOrbits.centerPaths }} />}
      ...
      <section className="pit-journey-scene pit-welcome-scene" aria-hidden={scene !== "welcome"}>
        ...
        <div className="welcome-route-stops" aria-hidden="true">
          {["心动证据库", "深渊放映厅", "表情补给站"].map((label, index) => {
        ...
        <div className="welcome-collage" ref={welcomeCollageRef}>
          ...
          <button className="welcome-enter-mark" type="button" onClick={restartJourney} aria-label="再次入新坑，重看开场">
